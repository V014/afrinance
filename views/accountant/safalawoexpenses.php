  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      .stat-card.budget-card .stat-value {
        color: var(--expenses);
      }
      .stat-card.budget-card .stat-value.high {
        color: var(--expenses);
      }
      .stat-card.budget-card .stat-value.low {
      ...
      .stat-card .progress-bar .progress-fill {
        height: 100%;
